...
CREATE TABLE `pessoafisica` (
  ...
  KEY `fk_PessoaFisica_Pessoa1_idx` (`pessoa`),
  CONSTRAINT `fk_PessoaFisica_Pessoa1` FOREIGN KEY (`pessoa`) REFERENCES `pessoa` (`idPessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION
