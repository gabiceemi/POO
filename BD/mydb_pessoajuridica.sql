...
CREATE TABLE `pessoajuridica` (
  ...
  KEY `fk_PessoaJuridica_Pessoa1_idx` (`pessoa`),
  CONSTRAINT `fk_PessoaJuridica_Pessoa1` FOREIGN KEY (`pessoa`) REFERENCES `pessoa` (`idPessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION
