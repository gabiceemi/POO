...
CREATE TABLE `passageiro` (
  ...
  KEY `fk_Passageiro_Pessoa1_idx` (`pessoa`),
  CONSTRAINT `fk_Passageiro_Pessoa1` FOREIGN KEY (`pessoa`) REFERENCES `pessoa` (`idPessoa`) ON DELETE NO ACTION ON UPDATE NO ACTION
